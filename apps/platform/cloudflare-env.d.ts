/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: 9b4d0a9a06c376300116d27780e4d538)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DemoRunMailbox";
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KAYLE_INTERNAL_TOKEN">> {}
}
