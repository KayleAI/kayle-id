/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file ../../.env --env-interface CloudflareBindings cloudflare-env.d.ts` (hash: 37365be6a0eefb31189fc855947e6bea)
// Runtime types generated with workerd@1.20251217.0 2025-12-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VerifySessionService";
	}
	interface Env {
		DATABASE_URL: string;
		AUTH_SECRET: string;
		...
		REDIS_URL: string;
		REDIS_TOKEN: string;
		VERIFY_SESSION: DurableObjectNamespace<import("./src/index").VerifySessionService>;
		STORAGE: R2Bucket;
	}
}
