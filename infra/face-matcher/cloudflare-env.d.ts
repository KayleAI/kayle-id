/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file ../../.env --env-interface FaceMatcherBindings cloudflare-env.d.ts` (hash: 359a2fde7255641c75817060e06ee7a1)
// Runtime types generated with workerd@1.20251217.0 2025-12-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FaceMatcherContainer";
	}
	interface Env {
		DATABASE_URL: string;
		AUTH_SECRET: string;
		...
		REDIS_URL: string;
		REDIS_TOKEN: string;
		FACE_MATCHER_CONTAINER: DurableObjectNamespace<import("./src/index").FaceMatcherContainer>;
		ASSETS: Fetcher;
	}
}
interface FaceMatcherBindings extends Cloudflare.Env {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "AUTH_SECRET" | "PUBLIC_AUTH_URL" | "REDIS_URL" | "REDIS_TOKEN">> {}
}
